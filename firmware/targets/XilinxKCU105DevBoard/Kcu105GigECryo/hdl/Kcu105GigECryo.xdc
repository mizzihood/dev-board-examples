...
set_property EQUALIZATION EQ_LEVEL0 [get_ports {asicD0out_p[0]}]
...
set_property EQUALIZATION EQ_LEVEL0 [get_ports {asicD1out_p[0]}]
...
set_property EQUALIZATION EQ_LEVEL0 [get_ports {asicD0out_p[1]}]
...
set_property EQUALIZATION EQ_LEVEL0 [get_ports {asicD1out_p[1]}]
