...
set_property -dict { PACKAGE_PIN  T22 IOSTANDARD LVCMOS18 } [get_ports { asicSaciSel[1]}]
set_property -dict { PACKAGE_PIN  T23 IOSTANDARD LVCMOS18 } [get_ports { asicSaciSel[0]}]
